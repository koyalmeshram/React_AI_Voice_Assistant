 ...
 recognition.onend = () =>setIsListening(false)
  ...
  const handleVoiceCommand = async (command) =>{
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'm Melo, Your voice assistant created by Koyal";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello melo")) {
      const response = "Hello Sir I'm Melo, How can i help you";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("what is your age")) {
      const response = "Hello Sir I'm Melo, I'm 2 day old";
      speakText(response);
      setInformation(response);
      return;
    }
